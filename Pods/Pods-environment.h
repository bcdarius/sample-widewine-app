...
#define COCOAPODS_POD_AVAILABLE_Brightcove_Player_SDK_Widevine
#define COCOAPODS_VERSION_MAJOR_Brightcove_Player_SDK_Widevine 1
#define COCOAPODS_VERSION_MINOR_Brightcove_Player_SDK_Widevine 0
#define COCOAPODS_VERSION_PATCH_Brightcove_Player_SDK_Widevine 6
...
// Widevine-iOS
#define COCOAPODS_POD_AVAILABLE_Widevine_iOS
